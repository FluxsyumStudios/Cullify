...
public class CullifyConfigScreen extends Screen {
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double delta) {
        if (this.currentTab == 0) {
            this.generalScroll = clamp(this.generalScroll - (int) (delta * 12), 0, getMaxGeneralScroll());
            return true;
        } else if (this.currentTab == 1) {
            this.vegetationScroll = clamp(this.vegetationScroll - (int) (delta * 12), 0, getMaxVegetationScroll());
            return true;
        }
